...
const products: Product[] = [
  ...
  { id: 13, name: "Red Velvet", price: 350, image: "https://www.thespruceeats.com/thmb/NQlKcmgH6A34snRB1CjFIGmRopc=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/homemade-red-velvet-cake-with-cooked-frosting-3053390-hero-01-a17ad925fbea47fa8585f6cd39a0167e.jpg"},
  { id: 14, name: "Raspberry Cake", price: 500, image: "https://www.mycakeschool.com/images/2023/04/Raspberry-Cake-Mix-Recipe-featured-image-.jpg"},
  { id: 15, name: "Oreo Cake", price: 450, image: "https://th.bing.com/th/id/OIP.tHEWOdNtR68MvJS2u-bd1QHaE8?cb=iwp2&rs=1&pid=ImgDetMain"},
  { id: 16, name: "White Forest Cake", price: 500, image: "https://cafecakeguru.com/wp-content/uploads/2021/06/White-Forest-Cake.jpg"},
  { id: 17, name: "Green Velvet Cake", price: 550, image: "https://food.fnr.sndimg.com/content/dam/images/food/fullset/2014/1/29/1/FN_St-Patricks-Day-Green-Velvet-Layer-Cake_s4x3.jpg.rend.hgtvcom.826.620.suffix/1391199935993.jpeg"},
  { id: 18, name: "Cookies and Cream Cake", price: 450, image: "https://alldayidreamaboutfood.com/wp-content/uploads/2019/10/Keto-Cookies-and-Cream-Cake-2.jpg"},
  { id: 19, name: "Ube Cake", price: 500, image: "https://th.bing.com/th/id/R.9ab7dd18e6b0c18326941a71b8f912ec?rik=iEkgNLSZhDUV1A&riu=http%3a%2f%2fflavorsoflife.com.ph%2fwp-content%2fuploads%2f2020%2f01%2fimage2-resized.jpg&ehk=bzqGPXcFGrvcj8evI3ZXaFBQ3Hc3DtQG7UIB3eDNX14%3d&risl=&pid=ImgRaw&r=0"},
  { id: 20, name: "Black Forest  Cake", price: 550, image: "https://static01.nyt.com/images/2020/01/15/dining/ss-black-forest-cake/merlin_165684495_6689b1a0-42b5-4228-b871-37bb983d797e-superJumbo.jpg"},
  { id: 21, name: "Chocolate  Mousse  Cake ", price: 650, image: "https://cafecakeguru.com/wp-content/uploads/2021/06/Chocolate-Cheese-Cake.jpg"},
  { id: 22, name: "Purple Yam", price: 600, image: "https://th.bing.com/th/id/OIP.lVlQkhmAhBRw8n4eyUolRwAAAA?cb=iwp2&rs=1&pid=ImgDetMain"},
];
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
              {products.map((product) => (
                <div key={product.id} className="flex flex-col items-center bg-white p-4 rounded-lg shadow h-full">
                  {/* Fixed height for image container, image fills the box */}
                  ...
                  <p className="mb-2 text-blue-700 font-bold">₱{product.price}</p>
                  <input
                    type="number"
                    min="1"
